...
var Methods = {
    ...
    PublishBook: function () {
        ...
        console.log(version);
        axios
            .post(url, { user_id:user_id ,book_name: book_name, price: price, good_description: good_description, user_id: user_id, dept_name: dept_name, category: category, publishing_house: publishing_house, version: version })
